...
import { validateSarl, validateSarlu, validateSaAg, validateSaUni, validateSaCa, validateSasu, validateSas, validateGie, validateStePart } from "../services/validator";
import { generateDocx, prepareSarlData, prepareSarluData, prepareSaAgData, prepareSaUniData, prepareSaCaData, prepareSasuData, prepareSasData, prepareGieData, prepareStePartData } from "../services/docx-generator";
