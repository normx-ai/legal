...
import { validateSarl, validateSarlu, validateSaAg, validateSaUni, validateSaCa, validateSasu, validateSas } from "../services/validator";
import { generateDocx, prepareSarlData, prepareSarluData, prepareSaAgData, prepareSaUniData, prepareSaCaData, prepareSasuData, prepareSasData } from "../services/docx-generator";
