...
export function prepareProjetFusionParticipationData(formData: FormData): TemplateData {
  ...
  return {
    ...
    // Participation de B dans A
    actions_detenues_par_b: formData.actions_detenues_par_b ? formatNumber(formData.actions_detenues_par_b) : "",
    ...
    ca_exercice_courant: formData.ca_exercice_courant ? formatNumber(formData.ca_exercice_courant) : "",
    benefice_exercice_courant: formData.benefice_exercice_courant ? formatNumber(formData.benefice_exercice_courant) : "",
