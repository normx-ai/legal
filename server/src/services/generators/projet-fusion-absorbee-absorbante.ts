...
export function prepareProjetFusionAbsorbeeAbsorbanteData(formData: FormData): TemplateData {
  ...
  return {
    ...
    actions_detenues_par_a: formData.actions_detenues_par_a ? formatNumber(formData.actions_detenues_par_a as number || 0) : "",
