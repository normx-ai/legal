/**
 * Script pour créer le template DOCX de la Convocation du commissaire aux comptes — SARL & SA OHADA
 * Modèle 12 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-convocation-cac-template.ts
 */
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:jc w:val="center"/><w:spacing w:after="0"/></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">{forme_juridique} au capital de {capital} FCFA</w:t></w:r></w:p>
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Convocation CAC \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== DESTINATAIRE =====
    t("M {commissaire_nom}"),
    t("Commissaire aux comptes"),
    t("Adresse {commissaire_adresse}"),
    t(""),

    // ===== ENVOI =====
    it("Lettre R/AR ou lettre par porteur"),
    t(""),

    // ===== OBJET =====
    b("Objet : Convocation d\u2019assembl\u00e9e g\u00e9n\u00e9rale, ou de r\u00e9union de conseil d\u2019administration"),
    t(""),

    // ===== CORPS =====
    t("M {commissaire_nom},"),
    t(""),
    t("Nous vous prions de bien vouloir assister \u00e0 {type_reunion_label} (ou la r\u00e9union du conseil d\u2019administration de notre soci\u00e9t\u00e9 qui sera r\u00e9unie le...) \u00e0 {heure_reunion} heures \u00e0 {lieu_reunion}, \u00e0 l\u2019effet de d\u00e9lib\u00e9rer sur l\u2019ordre du jour suivant :"),
    t(""),
    t("{ordre_du_jour}"),
    t(""),
    t("Veuillez croire, M {commissaire_nom}, l\u2019expression de notre consid\u00e9ration distingu\u00e9e."),
    t(""),
    t(""),
    ...
    // ===== NOTE =====
    it("Note : si la convocation est envoy\u00e9e par courrier \u00e9lectronique, il faudrait r\u00e9clamer l\u2019accus\u00e9 de r\u00e9ception au commissaire aux comptes."),
    t(""),
  ];
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/convocation-cac");
