/**
 * Script pour créer le template DOCX de la Renonciation aux Droits de Souscription — OHADA
 * Usage : npx tsx scripts/create-renonciation-droits-souscription-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Renonciation droits souscription \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("RENONCIATION AUX DROITS"),
    c("DE SOUSCRIPTION"),
    t(""),

    // ===== LE RENONCANT =====
    t("Je soussign\u00e9(e), {renonçant_civilite} {renonçant_prenom} {renonçant_nom},"),
    t("n\u00e9(e) le {renonçant_date_naissance} \u00e0 {renonçant_lieu_naissance},"),
    t("de nationalit\u00e9 {renonçant_nationalite},"),
    t("demeurant \u00e0 {renonçant_adresse},"),
    t(""),
    t("actionnaire de la soci\u00e9t\u00e9 {denomination}, {forme_sociale} au capital de {capital} FCFA, dont le si\u00e8ge social est situ\u00e9 \u00e0 {siege_social}, immatricul\u00e9e au RCCM sous le num\u00e9ro {numero_rccm},"),
    t(""),
    t("titulaire de {nb_actions} actions de ladite soci\u00e9t\u00e9, repr\u00e9sentant {pourcentage_capital} % du capital social,"),
    t(""),

    // ===== DÉCLARATION =====
    b("D\u00c9CLARE :"),
    t(""),
    t("Renoncer purement et simplement \u00e0 mon droit pr\u00e9f\u00e9rentiel de souscription aux {nb_actions_nouvelles} actions nouvelles \u00e9mises dans le cadre de l\u2019augmentation de capital d\u00e9cid\u00e9e par l\u2019assembl\u00e9e g\u00e9n\u00e9rale extraordinaire du {date_decision_augmentation}, portant le capital de {capital} FCFA \u00e0 {capital_apres_augmentation} FCFA."),
    t(""),
    t("Cette renonciation est faite {motif_renonciation}."),
    t(""),
    t("Je reconnais avoir \u00e9t\u00e9 inform\u00e9(e) que cette renonciation est irr\u00e9vocable et que je ne pourrai pr\u00e9tendre \u00e0 aucune indemnit\u00e9 \u00e0 ce titre."),
    t(""),
    t(""),
    ...
    t(""),
    t(""),
    t("{renonçant_prenom} {renonçant_nom}"),
    t(""),
    it("(Signature pr\u00e9c\u00e9d\u00e9e de la mention \u00ab BON POUR RENONCIATION \u00bb)"),
    t(""),
  ];
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/renonciation-droits-souscription");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }
  const outputPath = path.join(outputDir, "renonciation.docx");
