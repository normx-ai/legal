/**
 * Script pour créer le template DOCX du Pouvoir pour l'Assemblée Générale — SA OHADA
 * Usage : npx tsx scripts/create-pouvoir-ag-sa-template.ts
 */
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("POUVOIR"),
    c("POUR L\u2019ASSEMBL\u00c9E G\u00c9N\u00c9RALE \u2014 SA"),
    t(""),

    // ===== LE MANDANT =====
    t("Je soussign\u00e9(e), {mandant_civilite} {mandant_prenom} {mandant_nom},"),
    t("demeurant \u00e0 {mandant_adresse},"),
    t(""),
    t("propri\u00e9taire de {mandant_nb_actions} actions de la soci\u00e9t\u00e9 {denomination}, ouvrant droit \u00e0 {mandant_nb_voix} voix,"),
    t(""),

    // ===== DONNE POUVOIR =====
    b("DONNE POUVOIR \u00c0 :"),
    t(""),
    t("{mandataire_civilite} {mandataire_prenom} {mandataire_nom},"),
    t("demeurant \u00e0 {mandataire_adresse},"),
    t(""),
    t("pour me repr\u00e9senter \u00e0 l\u2019assembl\u00e9e g\u00e9n\u00e9rale {type_ag} de la soci\u00e9t\u00e9 {denomination} qui se tiendra le {date_ag} \u00e0 {heure_ag}, au si\u00e8ge social sis {siege_social}, ou en tout autre lieu o\u00f9 elle serait report\u00e9e."),
    t(""),
    ...
    // ===== POUVOIRS =====
    t("En cons\u00e9quence, en mon nom :"),
    t("- participer \u00e0 toutes d\u00e9lib\u00e9rations et \u00e9mettre tous votes ;"),
    t("- signer toutes feuilles de pr\u00e9sence et proc\u00e8s-verbaux ;"),
    t("- et g\u00e9n\u00e9ralement faire le n\u00e9cessaire."),
    t(""),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/pouvoir-ag-sa");
