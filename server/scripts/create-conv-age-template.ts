/**
 * Script pour créer le template DOCX de la Convocation AGE — SARL OHADA
 * Basé sur le modèle officiel du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-conv-age-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Convocation AGE \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    ...
    // ===== OBJET =====
    b("Objet : Convocation \u00e0 l\u2019Assembl\u00e9e G\u00e9n\u00e9rale Extraordinaire"),
    t(""),
    t(""),
    ...
    t("{destinataire_civilite} {destinataire_prenom} {destinataire_nom},"),
    t(""),
    t("J\u2019ai l\u2019honneur de vous informer que l\u2019Assembl\u00e9e G\u00e9n\u00e9rale Extraordinaire de la soci\u00e9t\u00e9 {denomination} se tiendra le :"),
    t(""),
    b("Date : {date_ag}"),
    b("Heure : {heure_ag}"),
    b("Lieu : {lieu_ag}"),
    ...
    // ===== DOCUMENTS =====
    t("Conform\u00e9ment aux dispositions de l\u2019article 345 de l\u2019Acte Uniforme OHADA relatif au droit des soci\u00e9t\u00e9s commerciales et du GIE, les documents suivants sont tenus \u00e0 votre disposition au si\u00e8ge social de la soci\u00e9t\u00e9 :"),
    t("- le texte des r\u00e9solutions propos\u00e9es ;"),
    t("- le rapport du G\u00e9rant exposant les motifs des modifications propos\u00e9es ;"),
    ...
    t(""),
    t("Nous vous rappelons que les d\u00e9cisions de l\u2019assembl\u00e9e g\u00e9n\u00e9rale extraordinaire sont prises \u00e0 la majorit\u00e9 des trois quarts (3/4) des parts sociales, conform\u00e9ment \u00e0 l\u2019article 355 de l\u2019Acte Uniforme OHADA."),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/conv-age");
