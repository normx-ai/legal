/**
 * Script pour cr\u00e9er le template DOCX du Projet de fusion avec participation de l'absorb\u00e9e dans l'absorbante
 * Mod\u00e8le 45 du Guide Pratique des Soci\u00e9t\u00e9s Commerciales et du GIE - OHADA
 * Inverse du mod\u00e8le 44 : la soci\u00e9t\u00e9 A (absorb\u00e9e) d\u00e9tient des actions de B (absorbante)
 * Usage : npx tsx scripts/create-projet-fusion-absorbee-absorbante-template.ts
 */
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p><w:pPr><w:jc w:val="center"/><w:spacing w:after="0"/></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:b/><w:sz w:val="20"/></w:rPr><w:t xml:space="preserve">Projet de fusion \u2014 Participation de l\u2019absorb\u00e9e dans l\u2019absorbante</w:t></w:r></w:p>
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Projet de fusion (absorb\u00e9e dans absorbante) \u2014 Mod\u00E8le 45</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    ...
    c("AVEC PARTICIPATION DE L\u2019ABSORB\u00c9E DANS L\u2019ABSORBANTE"),
    c("(Mod\u00e8le 45)"),
    t(""),
    ...
    // LIEN DE CAPITAL (inverse du mod\u00e8le 44)
    b("3\u00b0) LIEN DE CAPITAL :"),
    t("La soci\u00e9t\u00e9 A d\u00e9tient en portefeuille {actions_detenues_par_a} actions de la soci\u00e9t\u00e9 B, repr\u00e9sentant {pourcentage_participation} % du capital de la soci\u00e9t\u00e9 B."),
    t(""),
    ...
    // IV - Rapport d'\u00e9change et annulation
    b("IV - RAPPORT D\u2019\u00c9CHANGE ET ANNULATION D\u2019ACTIONS"),
    ...
    t("La soci\u00e9t\u00e9 B proc\u00e9dera \u00e0 une augmentation de capital de {augmentation_capital_b} FCFA, mais une partie de ses propres actions figurant parmi les \u00e9l\u00e9ments d\u2019actif qui lui seront apport\u00e9s par la soci\u00e9t\u00e9 A ({actions_detenues_par_a} actions), ces actions se trouveront annul\u00e9es de plein droit et son capital r\u00e9duit d\u2019un montant correspondant \u00e0 la valeur nominale de ces actions, soit {montant_reduction_capital_b} FCFA."),
    t(""),

    // V - Augmentation de capital
    b("V - AUGMENTATION DE CAPITAL DE LA SOCI\u00c9T\u00c9 B"),
    t("La soci\u00e9t\u00e9 B augmentera son capital de {augmentation_capital_b} FCFA par \u00e9mission de {nombre_actions_nouvelles_b} actions nouvelles de {nouvelles_actions_b_valeur} FCFA chacune, dont {actions_detenues_par_a} actions seront annul\u00e9es en raison de la participation de la soci\u00e9t\u00e9 A dans la soci\u00e9t\u00e9 B."),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/projet-fusion-absorbee-absorbante");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }
  const outputPath = path.join(outputDir, "projet-fusion-absorbee-absorbante.docx");
