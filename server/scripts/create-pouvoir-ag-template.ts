/**
 * Script pour créer le template DOCX du Pouvoir/Procuration AG — SARL OHADA
 * Basé sur le modèle officiel du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-pouvoir-ag-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Pouvoir AG \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("POUVOIR"),
    c("(Procuration pour repr\u00e9sentation en Assembl\u00e9e G\u00e9n\u00e9rale)"),
    it("(Article 333 de l\u2019Acte Uniforme OHADA relatif au droit des soci\u00e9t\u00e9s commerciales et du GIE)"),
    t(""),
    t(""),
    ...
    b("LE MANDANT :"),
    t(""),
    t("Je soussign\u00e9(e), {mandant_civilite} {mandant_prenom} {mandant_nom}, demeurant \u00e0 {mandant_adresse},"),
    t("associ\u00e9(e) de la soci\u00e9t\u00e9 {denomination}, {forme_juridique} au capital de {capital} {devise}, dont le si\u00e8ge social est sis \u00e0 {siege_social},"),
    t("titulaire de {mandant_parts} parts sociales,"),
    t(""),

    // ===== DONNE POUVOIR =====
    b("DONNE POUVOIR \u00c0 :"),
    t(""),
    t("{mandataire_civilite} {mandataire_prenom} {mandataire_nom}, demeurant \u00e0 {mandataire_adresse},"),
    t(""),
    t("{#is_ago}"),
    t("de me repr\u00e9senter \u00e0 l\u2019Assembl\u00e9e G\u00e9n\u00e9rale Ordinaire de la soci\u00e9t\u00e9 {denomination} qui se tiendra le {date_ag} \u00e0 {heure_ag} au {lieu_ag},"),
    t("{/is_ago}"),
    t("{#is_age}"),
    t("de me repr\u00e9senter \u00e0 l\u2019Assembl\u00e9e G\u00e9n\u00e9rale Extraordinaire de la soci\u00e9t\u00e9 {denomination} qui se tiendra le {date_ag} \u00e0 {heure_ag} au {lieu_ag},"),
    t("{/is_age}"),
    t(""),
    t("et d\u2019y voter en mon nom et pour mon compte sur toutes les questions inscrites \u00e0 l\u2019ordre du jour, \u00e0 savoir :"),
    t(""),
    t("{ordre_du_jour}"),
    t(""),
    t("et g\u00e9n\u00e9ralement prendre part \u00e0 toutes d\u00e9lib\u00e9rations, voter sur toutes propositions, signer tous proc\u00e8s-verbaux et pi\u00e8ces annexes, et faire tout ce qui sera n\u00e9cessaire."),
    t(""),
    t(""),

    // ===== MENTION LEGALE =====
    it("Conform\u00e9ment \u00e0 l\u2019article 333 de l\u2019Acte Uniforme OHADA, un associ\u00e9 peut se faire repr\u00e9senter par un autre associ\u00e9, sauf si la soci\u00e9t\u00e9 ne comprend que deux associ\u00e9s."),
    t(""),
    t(""),
    ...
    t(""),
    b("Le Mandant,"),
    t("{mandant_civilite} {mandant_prenom} {mandant_nom}"),
    t(""),
    it("(Signature pr\u00e9c\u00e9d\u00e9e de la mention \u00ab Bon pour pouvoir \u00bb)"),
    t(""),
    t(""),
  ];
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/pouvoir-ag");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }
  const outputPath = path.join(outputDir, "pouvoir.docx");
