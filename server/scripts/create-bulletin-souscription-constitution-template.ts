/**
 * Script pour créer le template DOCX du Bulletin de Souscription (Constitution) — OHADA
 * Usage : npx tsx scripts/create-bulletin-souscription-constitution-template.ts
 */
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:jc w:val="center"/><w:spacing w:after="0"/></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">{forme_sociale} en cours de constitution</w:t></w:r></w:p>
  <w:p><w:pPr><w:jc w:val="center"/><w:spacing w:after="120"/><w:pBdr><w:bottom w:val="single" w:sz="4" w:space="1" w:color="999999"/></w:pBdr></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Si\u00E8ge social pr\u00E9vu : {siege_social}</w:t></w:r></w:p>
</w:hdr>`);
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Bulletin de souscription (constitution) \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    ...
    c("(EN CAS DE CONSTITUTION)"),
    t(""),

    // ===== INFORMATIONS SOCIÉTÉ =====
    b("I. RENSEIGNEMENTS RELATIFS \u00c0 LA SOCI\u00c9T\u00c9 EN FORMATION"),
    t(""),
    t("D\u00e9nomination sociale : {denomination}"),
    t("Sigle : {sigle}"),
    t("Forme sociale : {forme_sociale}"),
    t("Objet social : {objet_social}"),
    t("Si\u00e8ge social pr\u00e9vu : {siege_social}"),
    t("Capital social : {capital} FCFA"),
    t("Nombre d\u2019actions \u00e0 \u00e9mettre : {nb_actions_total}"),
    t("Valeur nominale des actions : {valeur_nominale} FCFA"),
    t("Prix d\u2019\u00e9mission : {prix_emission} FCFA"),
    t("Dur\u00e9e de la soci\u00e9t\u00e9 : {duree_societe} ans"),
    t(""),
    ...
    // ===== SOUSCRIPTEUR =====
    b("III. RENSEIGNEMENTS RELATIFS AU SOUSCRIPTEUR"),
    t(""),
    ...
    b("IV. SOUSCRIPTION"),
    t(""),
    t("Le souscripteur d\u00e9clare souscrire {nb_actions_souscrites} actions d\u2019une valeur nominale de {valeur_nominale} FCFA chacune, soit un montant total de {montant_souscription} FCFA."),
    t(""),

    // ===== VERSEMENT =====
    b("V. VERSEMENT"),
    t(""),
    t("Le souscripteur d\u00e9clare verser la somme de {montant_verse} FCFA correspondant \u00e0 {fraction_versee} du montant de la souscription."),
    t(""),
    t("Le versement est effectu\u00e9 par {mode_versement} aupr\u00e8s de {banque_depositaire}, d\u00e9sign\u00e9(e) comme d\u00e9positaire des fonds."),
    t(""),
    t("Le solde sera lib\u00e9r\u00e9 dans les conditions pr\u00e9vues par les statuts et conform\u00e9ment aux dispositions de l\u2019AUSCGIE."),
    t(""),
    ...
    t(""),
    it("(Signature pr\u00e9c\u00e9d\u00e9e de la mention \u00ab BON POUR SOUSCRIPTION \u00c0 {nb_actions_souscrites} ACTIONS \u00bb)"),
    t(""),
  ];
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/bulletin-souscription-constitution");
