/**
 * Script pour créer le template DOCX de la Requête prorogation délai AGO — OHADA
 * Modèle 35 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-requete-prorogation-ago-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Requ\u00EAte prorogation AGO \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== ADRESSE =====
    t("Monsieur le Pr\u00e9sident du Tribunal de Commerce de {tribunal}"),
    t(""),

    // ===== TITRE =====
    c("REQU\u00CATE POUR PROROGATION DU D\u00c9LAI DE L\u2019ASSEMBL\u00c9E G\u00c9N\u00c9RALE ORDINAIRE ANNUELLE"),
    t(""),

    // ===== REQUÉRANT =====
    b("LE REQU\u00c9RANT :"),
    t(""),
    t("{requerant_civilite} {requerant_prenom} {requerant_nom}, agissant en qualit\u00e9 de {requerant_qualite} de la soci\u00e9t\u00e9 {denomination}, {forme_juridique} au capital de {capital} FCFA, immatricul\u00e9e au RCCM sous le num\u00e9ro {rc_numero}, dont le si\u00e8ge social est \u00e0 {siege_social}."),
    t(""),

    // ===== EXPOSÉ =====
    b("A L\u2019HONNEUR DE VOUS EXPOSER :"),
    t(""),
    t("Que l\u2019exercice social de la soci\u00e9t\u00e9 {denomination} a \u00e9t\u00e9 clos le {date_cloture_exercice}."),
    t(""),
    t("Que conform\u00e9ment aux dispositions de l\u2019article 548 de l\u2019Acte Uniforme relatif au droit des soci\u00e9t\u00e9s commerciales et du GIE, l\u2019assembl\u00e9e g\u00e9n\u00e9rale ordinaire annuelle doit se r\u00e9unir dans les {delai_legal} de la cl\u00f4ture de l\u2019exercice social, soit au plus tard le {date_limite_legale}."),
    t(""),
    t("Que pour les raisons ci-apr\u00e8s expos\u00e9es, il n\u2019a pas \u00e9t\u00e9 possible de r\u00e9unir l\u2019assembl\u00e9e dans le d\u00e9lai l\u00e9gal :"),
    t(""),
    t("{motif_prorogation}"),
    t(""),
    ...
    b("PAR CES MOTIFS :"),
    t(""),
    t("Le requ\u00e9rant a l\u2019honneur de vous demander de bien vouloir accorder une prorogation de {duree_prorogation_demandee} pour la tenue de l\u2019assembl\u00e9e g\u00e9n\u00e9rale ordinaire annuelle."),
    t(""),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/requete-prorogation-ago");
