/**
 * Script pour créer le template DOCX des Avis donnés au CAC des conventions — SA OHADA
 * Modèle 10 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-avis-cac-conventions-sa-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Avis CAC conventions SA \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("AVIS DONN\u00c9S AU COMMISSAIRE AUX COMPTES DES CONVENTIONS (SA AVEC ADMINISTRATEUR G\u00c9N\u00c9RAL)"),
    t(""),

    // ===== SECTION A =====
    b("A. Conventions conclues et autoris\u00e9es durant l\u2019exercice"),
    t(""),
    t("{commissaire_nom},"),
    t(""),
    t("Par application des dispositions de l\u2019Acte Uniforme relatif au droit des soci\u00e9t\u00e9s commerciales et du GIE, nous avons l\u2019honneur de vous signaler la convention conclue entre la soci\u00e9t\u00e9 et l\u2019administrateur g\u00e9n\u00e9ral. Cette convention a \u00e9t\u00e9 \u00e9tablie {convention_forme}."),
    t(""),
    t("Veuillez trouver ci-joint copie de la convention."),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/avis-cac-conventions-sa");
