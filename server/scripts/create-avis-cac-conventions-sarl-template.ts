/**
 * Script pour créer le template DOCX des Avis donnés au CAC des conventions — SARL OHADA
 * Modèle 10 bis du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-avis-cac-conventions-sarl-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Avis CAC conventions SARL \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("AVIS DONN\u00c9S AU COMMISSAIRE AUX COMPTES DES CONVENTIONS (SARL)"),
    t(""),

    // ===== CORPS =====
    t("{commissaire_nom},"),
    t(""),
    t("Par application des dispositions de la loi, nous avons l\u2019honneur de vous signaler la conclusion, le {date_convention}, {parties_convention}, d\u2019une convention relevant des articles 350 et suivants de l\u2019Acte Uniforme relatif aux soci\u00e9t\u00e9s commerciales et au GIE."),
    t(""),
    t("Nous vous prions de trouver ci-joint copie de la convention."),
    t(""),
    t("Veuillez agr\u00e9er, {commissaire_nom}, l\u2019expression de nos salutations distingu\u00e9es."),
    t(""),
    t(""),

    // ===== SECTION B (conditionnelle) =====
    t("{#has_conventions_anterieures}"),
    b("B. Conventions autoris\u00e9es aux cours d\u2019exercices ant\u00e9rieurs"),
    t(""),
    t("{commissaire_nom},"),
    t(""),
    t("Par application de la loi, nous avons l\u2019honneur de vous informer que les conventions ci-apr\u00e8s conclues et autoris\u00e9es en cours d\u2019exercices ant\u00e9rieurs \u00e0 l\u2019exercice {exercice}, ont \u00e9t\u00e9 poursuivies au cours dudit exercice :"),
    t(""),
    t("{conventions_anterieures}"),
    t(""),
    t("Nous restons \u00e0 votre disposition pour vous communiquer toutes indications et justifications."),
    t(""),
    t("Veuillez agr\u00e9er, {commissaire_nom}, l\u2019expression de nos salutations distingu\u00e9es."),
    t("{/has_conventions_anterieures}"),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/avis-cac-conventions-sarl");
