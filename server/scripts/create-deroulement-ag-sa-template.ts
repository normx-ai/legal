/**
 * Script pour cr\u00e9er le template DOCX du D\u00e9roulement AG SA \u2014 M\u00e9mo du Pr\u00e9sident
 * Mod\u00e8le 32ter du Guide Pratique des Soci\u00e9t\u00e9s Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-deroulement-ag-sa-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">D\u00e9roulement AG SA \u2014 M\u00e9mo du Pr\u00e9sident \u2014 Mod\u00E8le 32ter</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    ...
    t("Je pr\u00e9side l\u2019assembl\u00e9e g\u00e9n\u00e9rale en ma qualit\u00e9 de {president_qualite}."),
    t(""),

    b("Mise en place du bureau"),
    t("Conform\u00e9ment aux statuts, je d\u00e9signe :"),
    t("- Scrutateur 1 : {scrutateur1_nom}"),
    t("- Scrutateur 2 : {scrutateur2_nom}"),
    t("- Secr\u00e9taire de s\u00e9ance : {secretaire_nom}"),
    t(""),

    b("Rappel de l\u2019objet de la r\u00e9union et de l\u2019ordre du jour"),
    t("D\u2019apr\u00e8s la feuille de pr\u00e9sence, {nombre_actions_presentes} actions sont pr\u00e9sentes ou repr\u00e9sent\u00e9es, soit {pourcentage_capital}% du capital."),
    t("Le quorum est atteint (1/4 du capital pour l\u2019AGO sur premi\u00e8re convocation, 1/2 pour l\u2019AGE)."),
    t("L\u2019assembl\u00e9e g\u00e9n\u00e9rale peut valablement d\u00e9lib\u00e9rer."),
    t(""),

    b("D\u00e9p\u00f4t documents l\u00e9gaux et respect des dispositions l\u00e9gales"),
    t("Je d\u00e9pose sur le Bureau les documents l\u00e9gaux suivants vis\u00e9s par la loi :"),
    t("{documents}"),
    t(""),

    b("Pr\u00e9sentation des rapports"),
    t("\u2022 lecture rapport du conseil d\u2019administration (ou de l\u2019administrateur g\u00e9n\u00e9ral)"),
    t("Je vous donne lecture du rapport du conseil d\u2019administration."),
    t(""),
    t("\u2022 prise de connaissance des rapports du commissaire aux comptes"),
    ...
    b("Ouverture des d\u00e9bats"),
    t("La discussion est ouverte."),
    t(""),

    b("Vote des r\u00e9solutions"),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/deroulement-ag-sa");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }
  const outputPath = path.join(outputDir, "deroulement-ag-sa.docx");
