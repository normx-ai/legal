/**
 * Script pour créer le template DOCX de la Lettre d'information du CA de conventions soumises à autorisation — SA OHADA
 * Modèle 24 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-lettre-info-ca-conventions-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Lettre info CA conventions \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("LETTRE D\u2019INFORMATION DU CONSEIL D\u2019ADMINISTRATION DE CONVENTIONS SOUMISES \u00c0 AUTORISATION"),
    t(""),

    // ===== DESTINATAIRES =====
    t("Mesdames, Messieurs les administrateurs de la soci\u00e9t\u00e9 {denomination}"),
    t(""),

    // ===== OBJET =====
    b("Objet : Information convention r\u00e9glement\u00e9e"),
    t(""),

    // ===== CORPS =====
    t("Mesdames, Messieurs les administrateurs,"),
    t(""),
    t("Par application des dispositions de l\u2019article 440 de l\u2019Acte Uniforme relatif au droit des soci\u00e9t\u00e9s commerciales et du GIE, j\u2019ai l\u2019honneur de vous informer du projet de convention devant exister entre la soci\u00e9t\u00e9 {denomination} et le soussign\u00e9, et que je soumets \u00e0 votre autorisation."),
    t(""),
    t("Cette convention peut se r\u00e9sumer comme suit :"),
    t("- personnes concern\u00e9es par la convention : {personnes_concernees} ;"),
    t("- nature et objet de la convention : {nature_objet_convention} ;"),
    t("- modalit\u00e9s de la convention : {modalites_convention} ;"),
    t("- dur\u00e9e : {duree_convention}."),
    t(""),
    t("Vous trouverez ci-joint un original de cette convention."),
    t(""),
    t("Dans l\u2019attente d\u2019un avis favorable,"),
    t(""),
    t("je vous prie d\u2019agr\u00e9er, Mesdames, Messieurs les administrateurs, l\u2019expression de ma consid\u00e9ration distingu\u00e9e."),
    t(""),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/lettre-info-ca-conventions");
