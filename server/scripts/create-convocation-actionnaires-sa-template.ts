/**
 * Script pour créer le template DOCX de Convocation des actionnaires à l'AG — SA OHADA
 * Modèle 28 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-convocation-actionnaires-sa-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Convocation actionnaires AG \u2014 {denomination}</w:t></w:r>
...
function p(text: string, bold = false, size = 24, center = false, italic = false, right = false): string {
  let align: string;
  if (center) align = `<w:jc w:val="center"/>`;
  else if (right) align = `<w:jc w:val="right"/>`;
  else align = `<w:jc w:val="both"/>`;
  const bTag = bold ? `<w:b/>` : "";
...
const r = (text: string) => p(text, false, 24, false, false, true);
...
function createTemplate() {
  ...
  const body = [
    ...
    r("{destinataire_civilite} {destinataire_prenom} {destinataire_nom}"),
    r("Actionnaire"),
    r("{destinataire_adresse}"),
    t(""),

    // ===== MENTION ENVOI =====
    it("Lettre / AR ou lettre au porteur"),
    t(""),

    // ===== OBJET =====
    b("Objet : Convocation Assembl\u00e9e G\u00e9n\u00e9rale {type_ag_label}"),
    t(""),

    // ===== CORPS =====
    t("{destinataire_civilite} {destinataire_prenom} {destinataire_nom},"),
    t(""),
    t("Nous prions d\u2019assister \u00e0 l\u2019assembl\u00e9e g\u00e9n\u00e9rale {type_ag_label} de notre soci\u00e9t\u00e9 qui sera r\u00e9unie \u00e0 {lieu_ag} le {date_ag} \u00e0 {heure_ag} \u00e0 l\u2019effet de d\u00e9lib\u00e9rer sur l\u2019ordre du jour suivant :"),
    t(""),
    t("{ordre_du_jour}"),
    t(""),
    t("Tout actionnaire pourra participer personnellement \u00e0 l\u2019assembl\u00e9e ou s\u2019y faire repr\u00e9senter par un mandataire de son choix."),
    t(""),
    t("Des formules de procuration sont \u00e0 disposition au si\u00e8ge social ou sont jointes \u00e0 la pr\u00e9sente."),
    t(""),
    t("Nous vous prions d\u2019agr\u00e9er, {destinataire_civilite} {destinataire_prenom} {destinataire_nom}, l\u2019expression de nos sentiments distingu\u00e9s."),
    t(""),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/convocation-actionnaires-sa");
