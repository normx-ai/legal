...
function createTemplate() {
  ...
  const body = [
    ...
    t(""),
    t("Que conform\u00e9ment aux dispositions des articles {articles_reference} de l\u2019Acte uniforme relatif au droit des soci\u00e9t\u00e9s commerciales et du groupement d\u2019int\u00e9r\u00eat \u00e9conomique (AUSCGIE), il est obligatoire de faire \u00e9valuer les apports en nature par un commissaire aux apports d\u00e9sign\u00e9 par la juridiction comp\u00e9tente."),
    t(""),

    // ===== DEMANDE =====
    b("PAR CES MOTIFS :"),
    t(""),
    t("Le requ\u00e9rant a l\u2019honneur de vous demander de bien vouloir d\u00e9signer un commissaire aux apports, choisi parmi les experts-comptables agr\u00e9\u00e9s ou les experts judiciaires, aux fins de :"),
    t(""),
