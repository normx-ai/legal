/**
 * Script pour créer le template DOCX du Pouvoir au Conseil d'Administration — SA OHADA
 * Modèle 22 du Guide Pratique des Sociétés Commerciales et du GIE - OHADA
 * Usage : npx tsx scripts/create-pouvoir-ca-template.ts
 */
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p><w:pPr><w:tabs><w:tab w:val="center" w:pos="4536"/><w:tab w:val="right" w:pos="9072"/></w:tabs></w:pPr>
    <w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="18"/></w:rPr><w:t xml:space="preserve">Pouvoir CA \u2014 {denomination}</w:t></w:r>
...
function createTemplate() {
  ...
  const body = [
    // ===== TITRE =====
    c("POUVOIR AU CONSEIL D\u2019ADMINISTRATION"),
    t(""),

    // ===== LE MANDANT =====
    t("Je soussign\u00e9(e), {mandant_civilite} {mandant_prenom} {mandant_nom},"),
    t("domicili\u00e9(e) \u00e0 {mandant_adresse},"),
    t("Administrateur de la soci\u00e9t\u00e9 {denomination},"),
    t(""),

    // ===== DONNE POUVOIR =====
    t("donne pouvoir par les pr\u00e9sentes \u00e0 {mandataire_civilite} {mandataire_prenom} {mandataire_nom},"),
    t("administrateur de la soci\u00e9t\u00e9 aux fins de me repr\u00e9senter \u00e0 la r\u00e9union du conseil d\u2019administration de ladite soci\u00e9t\u00e9 qui aura lieu \u00e0 {lieu_reunion} le {date_reunion} \u00e0 {heure_reunion},"),
    t(""),
    t("\u00e0 l\u2019effet de d\u00e9lib\u00e9rer sur l\u2019ordre du jour suivant :"),
    t(""),
    t("{ordre_du_jour}"),
    t(""),
    t("En cons\u00e9quence, en mon nom, participer \u00e0 la d\u00e9lib\u00e9ration, prendre toutes d\u00e9cisions et g\u00e9n\u00e9ralement faire le n\u00e9cessaire."),
    t(""),
    t(""),
...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  const outputDir = path.join(__dirname, "../templates/pouvoir-ca");
