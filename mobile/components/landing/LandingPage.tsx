  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "#ffffff" }}>
      ...
      <View style={{ alignItems: "center", paddingTop: isMobile ? 60 : 100, paddingBottom: 60, paddingHorizontal: 24, backgroundColor: BG_WARM }}>
        ...
        <Text style={{ fontFamily: fonts.black, fontWeight: fontWeights.black, fontSize: isMobile ? 30 : 52, color: DARK, textAlign: "center", lineHeight: isMobile ? 36 : 60, marginBottom: 20, letterSpacing: -0.5 }}>
          {"Générez vos actes\njuridiques en "}
          <Text style={{ color: PRIMARY }}>quelques clics</Text>
        </Text>

        <Text style={{ fontSize: isMobile ? 15 : 18, color: TEXT_SEC, maxWidth: 560, textAlign: "center", lineHeight: isMobile ? 24 : 30, fontFamily: fonts.regular, marginBottom: 36 }}>
          59 modèles de documents conformes au droit OHADA — statuts, PV, cessions, convocations, rapports. Remplissez le formulaire, téléchargez le document.
        </Text>
        ...
        <View style={{ flexDirection: isMobile ? "column" : "row", gap: 12, alignItems: "center", marginBottom: 48 }}>
          ...
          <TouchableOpacity onPress={login} style={{ paddingVertical: 14, paddingHorizontal: 32, borderRadius: 10, borderWidth: 1.5, borderColor: "rgba(0,0,0,0.1)", backgroundColor: "#ffffff" }}>
            <Text style={{ color: DARK, fontSize: 16, fontFamily: fonts.semiBold, fontWeight: fontWeights.semiBold }}>Créer un compte</Text>
          </TouchableOpacity>
        </View>

        {/* Stats bar */}
        <View style={{ flexDirection: "row", backgroundColor: DARK, borderRadius: 16, paddingVertical: 24, paddingHorizontal: isMobile ? 16 : 48, width: "100%", maxWidth: 800 }}>
          {STATS.map((s, i) => (
            <View key={i} style={{ flex: 1, alignItems: "center", borderRightWidth: i < STATS.length - 1 ? 1 : 0, borderRightColor: "rgba(255,255,255,0.15)" }}>
              <Text style={{ fontSize: isMobile ? 20 : 28, fontFamily: fonts.black, fontWeight: fontWeights.black, color: PRIMARY }}>{s.value}</Text>
