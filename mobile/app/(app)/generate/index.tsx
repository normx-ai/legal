    ...
    sections: [
      ...
      },
      {
        ...
        docs: [
          ...
          { id: "pv-ago", label: "PV AGO (SARL)", available: true },
          { id: "pv-age", label: "PV AGE (SARL)", available: true },
          { id: "rapport-gestion", label: "Rapport de gestion", available: true },
      ...
      },
      {
        ...
        docs: [
          ...
          { id: "feuille-presence", label: "Feuille de présence AG (SARL)", available: true },
          { id: "pouvoir-ag-sa", label: "Pouvoir pour AG (SA)", available: true },
          { id: "pouvoir-ag", label: "Pouvoir pour AG (SARL)", available: true },
          { id: "conv-age", label: "Convocation AGE (SARL)", available: true },
          { id: "conv-ago", label: "Convocation AGO (SARL)", available: true },
