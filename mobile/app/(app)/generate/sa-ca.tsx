    ...
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      <View style={{ backgroundColor: colors.headerBg, paddingTop: 50, paddingBottom: 16, paddingHorizontal: 20 }}>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ fontFamily: fonts.semiBold, fontWeight: fontWeights.semiBold, fontSize: 18, color: "#ffffff" }}>Statuts SA — Conseil d'Administration</Text>
            <Text style={{ fontFamily: fonts.regular, fontSize: 13, color: "rgba(255,255,255,0.7)" }}>Etape {w.currentStep + 1} / {STEPS.length} — {STEPS[w.currentStep]}</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row", padding: 16, gap: 12, backgroundColor: "#ffffff", borderTopWidth: 1, borderTopColor: "#e2e8f0" }}>
          {w.currentStep > 0 && (
            <TouchableOpacity onPress={w.prevStep} style={{ flex: 1, padding: 14, borderWidth: 1, borderColor: "#e2e8f0", alignItems: "center" }}>
              <Text style={{ fontFamily: fonts.medium, fontSize: 15, color: colors.text }}>Precedent</Text>
            </TouchableOpacity>
          )}
